		...
		<div class="container col-md-5 col-md-offset-4 col-sm-offset-1 col-xs-offset-1">
			...
			<form action="/marcenaria/cliente" method="post" id="form1">
			  <div class="form-group">
				    ...
				    <input type="text" class="form-control" id="nome" name="nome" placeholder="Maria José">
					</div>
			  </div>
				<div class="form-group">
					<div class="form-group col-md-6">
						<label for="cpf">CPF</label>
						<input type="text" class="form-control" id="cpf" name="cpf" placeholder="1234567890">
					</div>
					<div class="form-group col-md-6">
			  ...
			  <div class="form-group">
				...
				<div class="form-group">
					<div class="form-group col-md-6">
						...
						<input type="text" class="form-control" id="tel" name="tel" placeholder="(DDD)">
					</div>
					<div class="form-group col-md-6">
						<label for="cel">Celular</label>
						<input type="text" class="form-control" id="cel" name="cel" placeholder="(DDD)">
					</div>
				</div>
				<div class="form-group">
					<div class="form-group col-md-12">
